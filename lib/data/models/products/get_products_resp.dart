class GetProductsResp {
  List<Products>? products;
  int? count;
  int? offset;
  int? limit;

  GetProductsResp({this.products, this.count, this.offset, this.limit});

  GetProductsResp.fromJson(Map<String, dynamic> json) {
...
class Variants {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.originalPriceInclTax != null) {
      data['original_price_incl_tax'] = this.originalPriceInclTax;
    }
    if (this.calculatedPriceInclTax != null) {
      data['calculated_price_incl_tax'] = this.calculatedPriceInclTax;
    }
    if (this.originalTax != null) {
      data['original_tax'] = this.originalTax;
    }
    if (this.calculatedTax != null) {
      data['calculated_tax'] = this.calculatedTax;
    }
